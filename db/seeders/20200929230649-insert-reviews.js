...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Reviews', [
      ...
      {
        bookId: 11,
        description: "â€œ...Reason should take on anew the most difficult of all its tasks, namely, that of self-knowledge, and to institute a court of justice, by which reason may secure its rightful claims while dismissing all its groundless pretensions, and this not by mere decrees but according to its own eternal and unchangeable laws; and this court is none other than the critique of pure reason itself.â€",
        userId: 3,
        createdAt: new Date(),
      ...
      {
        bookId: 18,
        description: "Some very interesting ideas here imprisoned in a lot of opaque, tortuous sentences. Postmodern â€˜academeseâ€™ remains the only major European language that I am completely incapable of understanding. I am also sick to death of seeing intelligent friends, both here and in real life, make apologetic comments about how they weren't quite up to the task of fully engaging with texts like this â€“ as if it were their fault!",
        userId: 1,
        createdAt: new Date(),
